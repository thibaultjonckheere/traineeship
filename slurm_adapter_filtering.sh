...
#SBATCH -o test_adapter_filtering%A.out     # standard output
#SBATCH -e test_adapter_filtering%A.err     # standard error
...
projDir=`pwd`
mkdir -p jobs/test_adapter_filtering_$SLURM_JOB_ID
jobDir=$projDir/jobs/test_adapter_filtering_$SLURM_JOB_ID
