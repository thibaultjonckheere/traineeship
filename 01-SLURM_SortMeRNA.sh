...
#SBATCH -J fastQC_SortMeRNA_fastQC_119_L001     # job name
#SBATCH -o out/fastQC_SortMeRNA_fastQC_119_L001_%A.out # standard output
#SBATCH -e err/fastQC_SortMeRNA_fastQC_119_L001_%A.err # standard error
...
P18452_119_S38_L001_R1_001.fastq P18452_119_S38_L001_R2_001.fastq \
reads_interleaved.fq
...
--fastx --aligned reads_rRNA --other reads_non_rRNA --log -a 16 --paired_in -v

#unmerging filtered file 
/sw/bioinfo/SortMeRNA/2.1b/rackham/scripts/unmerge-paired-reads.sh \
reads_non_rRNA.fq reads_119_L001_non_rRNA_1.fq reads_119_L001_non_rRNA_2.fq
